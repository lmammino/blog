...
> — [@mgattozi](https://twitter.com/mgattozzi/status/960607169375850496?s=09) (paraphrased)
...
[topic of structured concurrency](http://libdill.org/structured-concurrency.html). The Tl;Dr being:
if you can express concurrency as a tree, it's a lot easier to reason about. And the same applies to
error handling too.
